...
const featureTypes = {
  Polygon: import("./feature_types/polygon"),
  LineString: import("./feature_types/line_string"),
  Point: import("./feature_types/point"),
  MultiPolygon: import("./feature_types/multi_feature"),
  MultiLineString: import("./feature_types/multi_feature"),
  MultiPoint: import("./feature_types/multi_feature"),
};
